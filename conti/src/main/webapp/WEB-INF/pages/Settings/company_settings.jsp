		...
		<div id="page-wrapper">
			...
			<div class="row customer-field">
				<div class="col-lg-12">
					...
					<div class="col-lg-3">
						...
						<span>Password</span> <input type="text" class="form-control">
			...
			<div class="row customer-field">
				<div class="col-lg-12">
					...
					<div class="col-lg-3">
						<span>Company Name</span> <input type="text" class="form-control">

						<span>Company Address</span> <input type="text"
							class="form-control"> <span>Phone Number</span> <input
							type="text" class="form-control"> <span>Mail</span> <input
							type="text" class="form-control"> <span>Contact
							Person</span> <input type="text" class="form-control">
			...
			<div class="row customer-field">
				<div class="col-lg-12">
					...
					<div class="col-lg-3">
						<span>Default Time Zone</span> <input type="text"
							class="form-control"> <span>Exp.No.of.days for
							Delivery</span> <input type="text" class="form-control"> <span>Tax
							GST %</span> <input type="text" class="form-control"> <span>Application
							Time Out(mins)</span> <input type="text" class="form-control">
